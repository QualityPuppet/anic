...
const progress = computed(() => {
    ...
    return ranked == 0 || total == 0 ? 0 : Math.ceil(ranked / total * 100);
})
</script>
    ...
    <div>
        <el-row>
            <el-input style="width: 40%" v-model="state.Username" v-on:keyup.enter="anilistLoad"
                ...
                <template #append>
                    <el-button class="" @click="anilistLoad" ref="anilistLoadButton" :loading="state.Loading">Load From
                        Anilist</el-button>
                </template>
            </el-input>
                            ...
                            <el-row justify="space-between">
                                ...
                                <el-col :span="4">
                                    <el-row>
                                        ...
                                        <el-checkbox v-model="editMode" label="Edit mode enabled">
                                            <WarnTriangleFilled style="height:1em" /> Edit mode
                                        </el-checkbox>
                                    </el-row>
                                </el-col>
                            </el-row>
