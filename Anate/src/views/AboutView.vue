    ...
    <div class="about" style="height: 100%">
        <el-row justify="center" align="middle" style="width: 100%">
            <el-col :span="4">
                <img
                    class="avatar"
                    src="https://avatars.githubusercontent.com/u/19232517"
                />
            </el-col>
            <el-col :span="12">
                <el-row>
                    <h1 v-if="!japanese">
                        <FontAwesomeIcon
                            @click="japanese = !japanese"
                            class="clickable"
                            :icon="faEarthAsia"
                        />
                        Hi! I'm
                        <a href="https://www.github.com/QualityPuppet">Eve!</a>
                    </h1>
                    <h1 v-if="japanese">
                        <FontAwesomeIcon
                            @click="japanese = !japanese"
                        ...
                        />
                        おはよう! 私は<a
                            href="https://www.github.com/QualityPuppet"
                            >エビだよ!</a
                        >
                    </h1>
                </el-row>
                <el-row :span="12">
                    <el-text size="large">
                        <p>
                            I enjoy watching anime and statistics, so I wanted
                            to leverage
                            <a href="https://malsync.moe/">MAL-Sync</a>
                            (and the coding knowledge I reportedly have) to make
                            a programmatic way of sorting and then statistically
                            ranking the anime I've watched.
                        </p>
                        <br />
                        <p>
                            As of September 2026, this is the
                            <code>{{ version }}</code> version of the website.
                            Version <code>{{ getVersion("1.0.0") }} </code> to
                            <code>{{ getVersion("1.3.1") }}</code> implemented
                            the base skeleton for the website
                        </p>
                        <br />
                        <p>
                            <code>{{ version }}</code> implements a
                            <code>statistics</code> page that leverages a normal
                            distribution to map out scores, with an aim to make
                            that editable so the bell curve can be adjusted to
                            suit a user's scoring preferences (centred around an
                            approximate average user score) clean up some bugs
                            and CSS flaws, then get the anilist sync code
                            working for what, in theory, is a finished product.
                        </p>
                        <br />
                        <p>
                            Feel free to take a look at the current things I
                            want to implement
                            <a
                                target="_blank"
                                href="https://github.com/users/QualityPuppet/projects/2/views/5"
                                >here</a
                            >!
                        </p>
                    </el-text>
